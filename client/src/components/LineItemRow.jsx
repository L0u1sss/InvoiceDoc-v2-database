...
export default function LineItemRow({
  ...
  return (
    ...
    >
      ...
      <td>
        <div style={{ textAlign: "right", color: "var(--text-main)", fontSize: "0.95rem", padding: "8px 12px", background: "var(--bg-body)", borderRadius: "var(--radius-sm)" }}>
      ...
      <td>
        <div style={{ textAlign: "right", color: "#ef4444", fontSize: "0.95rem", padding: "8px 12px", background: "#fef2f2", borderRadius: "var(--radius-sm)" }}>
          - {formatBaht(computeDiscountAmount(it))}
        </div>
      </td>
      <td>
        <div style={{ textAlign: "right", fontWeight: 600, color: "var(--primary)", fontSize: "0.95rem", padding: "8px 12px", background: "var(--bg-body)", borderRadius: "var(--radius-sm)" }}>
